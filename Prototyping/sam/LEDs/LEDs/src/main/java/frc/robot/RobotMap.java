...
class RobotMap{
    ...
    public static final int shotMotor       =   30;     //Talon FX
    ...
    public static final int _ballCollected  =  101;     //Lower Distance Sensor
    public static final int _intakeFull     =  102;     //Upper Distance Sensor
